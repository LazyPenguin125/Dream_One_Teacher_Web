                                    ...
                                    {a.feedback ? (
                                        <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-sm font-black text-amber-700">輔導員回饋</span>
                                            </div>
                                            <p className="text-amber-900 text-sm leading-relaxed whitespace-pre-wrap">{a.feedback}</p>
                                        </div>
                                    ) : (
